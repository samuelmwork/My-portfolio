          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {services.map((s, i) => (
              <motion.div
                ...
                className="group relative bg-white/3 backdrop-blur-sm border border-white/5 rounded-2xl p-6 hover:border-accent/30 hover:bg-accent/5 transition-all duration-500 overflow-hidden"
              >
                {/* BG accent on hover */}
